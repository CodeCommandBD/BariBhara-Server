...
export const generateInvoicePDF = (data) => {
    return new Promise((resolve, reject) => {
        ...
        doc
            ...
            .fill(WHITE)
            .font("Helvetica")
            .text("This is a computer-generated invoice. No physical signature required. | Bari Bhara Rental Management System", margin, footerY + 5, { width: contentW, align: "center" });
        doc.end();
    });
};
// ====================================================
...
// ====================================================
export const generateInvoiceNumber = (invoiceId) => {
